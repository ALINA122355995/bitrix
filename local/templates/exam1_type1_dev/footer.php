...
<div class="footer-search">
	...
	"poick", 
	array(
		"PAGE" => "/s2/search/index.php",
		"USE_SUGGEST" => "N",
		"COMPONENT_TEMPLATE" => "poick"
	),
	false
);?>
			...
			<div class="row gy-4">
				...
				<div class="col-lg-4 col-md-12">
					...
					<div class="social-links d-flex">
						<a class="forimg" href="#"><img src="/local/templates/exam1_type1_dev/assets/img/ico/vk_w.svg"></a>
					</div>
				</div>
...
Asset::getInstance()->addCss(SITE_TEMPLATE_PATH . "/local/templates/.default/fonts/icomoon/style.css");


Asset::getInstance()->addJs(SITE_TEMPLATE_PATH . "/assets/vendor/bootstrap/js/bootstrap.bundle.min.js");
Asset::getInstance()->addJs(SITE_TEMPLATE_PATH . "/assets/vendor/aos/aos.js");

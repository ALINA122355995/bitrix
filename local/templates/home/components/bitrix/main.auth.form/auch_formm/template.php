...
<div class="col-md-12 col-lg-8 mb-5">
	...
	<form name="<?= $arResult['FORM_ID'];?>" method="post" target="_top" class="p-5 bg-white border" action="<?= POST_FORM_ACTION_URI;?>">

	<div class="row form-group">
	<div class="col-md-12 mb-3 mb-md-0"><?= Loc::getMessage('MAIN_AUTH_FORM_FIELD_LOGIN');?></div>
	<div class="col-md-12 mb-3 mb-md-0">
		...
		<div class="row form-group">
		<div class="col-md-12 mb-3 mb-md-0"><?= Loc::getMessage('MAIN_AUTH_FORM_FIELD_PASS');?></div>
		<div class="col-md-12 mb-3 mb-md-0">
				...
				<?endif?>
				<input type="password"  class="form-control" name="<?= $arResult['FIELDS']['password'];?>" maxlength="255" autocomplete="off" />
			</div>
		</div>
  ...
  <div class="col-md-12 col-lg-8 mb-5">
	...
	<h5 class="bx-title"><?= Loc::getMessage('MAIN_AUTH_FORM_HEADER');?></h5>
